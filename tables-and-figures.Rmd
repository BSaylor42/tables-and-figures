...
```{r table t test site vegetation differences, fig.align='center'}
table_site_veg <- combined.grassland %>%
  select(site_type, litter_avg, veg_ht_avg, vd_vo, pc_woody, pc_grass) %>% #retain variables used in summaries
  ...
  modify_caption("Table 3. Vegetation Characteristics of the Different Site Types") %>%
