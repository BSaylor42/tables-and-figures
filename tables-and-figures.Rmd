...
```
<br> 
Let's explore how the similarities and differences among the site types.

### **Vegetation Characteristics**
First, let's explore how the vegetation looked at each site. Observers also conducted vegetation surveys at each point count location, measuring a variety of vegetation characters such as vegetation height, density, litter depth, ground cover, and percent cover. 
...
```{r histogram site size, message=FALSE, fig.align='center'}
...
```{r boxplots species richness, echo=FALSE, fig.align='center', message=FALSE}
